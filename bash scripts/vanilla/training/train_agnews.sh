...
#SBATCH --gpus=1
#SBATCH --mem=32G
#SBATCH --output=vanilla_rest_agnews.out
...
# /nas/home/gpinto/miniconda3/envs/conal_reprod/bin/python -m training.train_classifier data/${trained_dataset}/2/ \
#     models/${trained_dataset}/2/${trained_model_name}_seed_1 \
#     --ood_training_type vanilla \
#     --model_type ${trained_model_name} \
#     --num_training_steps 5000 \
#     --checkpoint_steps 100 \
...
# /nas/home/gpinto/miniconda3/envs/conal_reprod/bin/python -m training.train_classifier data/${trained_dataset}/2/ \
#     models/${trained_dataset}/2/${trained_model_name}_seed_2 \
#     --ood_training_type vanilla \
#     --model_type ${trained_model_name} \
#     --num_training_steps 5000 \
#     --checkpoint_steps 100 \
...
#     /nas/home/gpinto/miniconda3/envs/conal_reprod/bin/python -m training.train_classifier data/${trained_dataset}/2/ \
#     models/${trained_dataset}/2/${trained_model_name}_seed_3 \
#     --ood_training_type vanilla \
#     --model_type ${trained_model_name} \
#     --num_training_steps 5000 \
#     --checkpoint_steps 100 \
...
#     /nas/home/gpinto/miniconda3/envs/conal_reprod/bin/python -m training.train_classifier data/${trained_dataset}/2/ \
#     models/${trained_dataset}/2/${trained_model_name}_seed_4 \
#     --ood_training_type vanilla \
#     --model_type ${trained_model_name} \
#     --num_training_steps 5000 \
#     --checkpoint_steps 100 \
...
#     /nas/home/gpinto/miniconda3/envs/conal_reprod/bin/python -m training.train_classifier data/${trained_dataset}/2/ \
#     models/${trained_dataset}/2/${trained_model_name}_seed_5 \
#     --ood_training_type vanilla \
#     --model_type ${trained_model_name} \
#     --num_training_steps 5000 \
#     --checkpoint_steps 100 \
